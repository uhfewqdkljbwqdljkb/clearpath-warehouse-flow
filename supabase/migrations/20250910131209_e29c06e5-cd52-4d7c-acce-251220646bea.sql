...
-- Pending orders
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-001', 'outbound', 'pending', CURRENT_DATE + INTERVAL '1 day', 'Rush order for weekend promotion'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-002', 'outbound', 'pending', CURRENT_DATE + INTERVAL '2 days', 'Regular weekly order'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-003', 'outbound', 'pending', CURRENT_DATE, 'Same day delivery required'),

-- Processing orders
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-004', 'outbound', 'processing', CURRENT_DATE, 'Currently being picked'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-005', 'outbound', 'processing', CURRENT_DATE - INTERVAL '1 day', 'Quality check in progress'),

-- Shipped orders
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-006', 'outbound', 'shipped', CURRENT_DATE - INTERVAL '1 day', 'Shipped via Aramex'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-007', 'outbound', 'shipped', CURRENT_DATE - INTERVAL '2 days', 'Express delivery'),

-- Completed orders (for analytics)
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-008', 'outbound', 'completed', CURRENT_DATE - INTERVAL '3 days', 'Successfully delivered'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-009', 'outbound', 'completed', CURRENT_DATE - INTERVAL '5 days', 'Customer satisfied'),
((SELECT id FROM companies WHERE name = 'TechShop Electronics'), (SELECT user_id FROM profiles WHERE email = 'john@techshop.com'), 'ORD-24-010', 'outbound', 'completed', CURRENT_DATE - INTERVAL '7 days', 'Repeat customer order');
