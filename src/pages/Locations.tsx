...
import { Package, TrendingUp, Warehouse, Plus, Search, MapPin, Users, BarChart3, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive warehouse overview and location allocations
          </p>
        </div>
