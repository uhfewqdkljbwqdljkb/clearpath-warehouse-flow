...
export function ProductImportDialog({
  ...
  const downloadTemplate = () => {
    ...
    const products = [
      ...
      ['T-Shirt', 'Size', 'Small', 100, 'Spring collection'],
      ['T-Shirt', 'Size', 'Medium', 150, 'Spring collection'],
      ['T-Shirt', 'Size', 'Large', 120, 'Spring collection'],
      ['Wireless Headphones', '', '', 50, 'No variants'],
      ['Coffee Mug', 'Color', 'Red', 75, ''],
      ['Coffee Mug', 'Color', 'Blue', 80, ''],
    ];
